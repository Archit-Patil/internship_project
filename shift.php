...
<!-- create table mt(l_id varchar(20)references labs(id),p_serial varchar(20),p_type varchar(20),foreign key(p_serial,p_type) references product(serial_no,name)); -->